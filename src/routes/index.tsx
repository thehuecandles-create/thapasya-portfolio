...
type Category = "All" | "Color Correction and Re-touchup" | "Environment Concept Art" | "Story Book Designs" | "Story Board" | "3D Asset Designs" | "Storyboard Animatics" | "Character Designing" | "Sketching" | "Digital Painting" | "Posters" | "Frame By Frame Animation";
...
const works: {
  ...
  { title: "Color Correction", tag: "Portfolio Artwork", category: "Color Correction and Re-touchup", gradient: "var(--gradient-sage)", image: "https://rwknlleecsparayybuek.supabase.co/storage/v1/object/public/portfolio/COLOR-CORRECTION.jpg" },
  { title: "Color Correction 6", tag: "Portfolio Artwork", category: "Color Correction and Re-touchup", gradient: "var(--gradient-sage)", image: "https://rwknlleecsparayybuek.supabase.co/storage/v1/object/public/portfolio/COLOR-CORRECTION-6.jpg" },
  { title: "Color Correction 4", tag: "Portfolio Artwork", category: "Color Correction and Re-touchup", gradient: "var(--gradient-sage)", image: "https://rwknlleecsparayybuek.supabase.co/storage/v1/object/public/portfolio/COLOR-CORRECTION-4.jpg" },
  { title: "Color Correction 5", tag: "Portfolio Artwork", category: "Color Correction and Re-touchup", gradient: "var(--gradient-sage)", image: "https://rwknlleecsparayybuek.supabase.co/storage/v1/object/public/portfolio/COLOR-CORRECTION-5.jpg" },
  { title: "Color Correction 1", tag: "Portfolio Artwork", category: "Color Correction and Re-touchup", gradient: "var(--gradient-sage)", image: "https://rwknlleecsparayybuek.supabase.co/storage/v1/object/public/portfolio/color-correction-1.jpg" },
  { title: "Color Correction A", tag: "Portfolio Artwork", category: "Color Correction and Re-touchup", gradient: "var(--gradient-sage)", image: "https://rwknlleecsparayybuek.supabase.co/storage/v1/object/public/portfolio/COLOR-CORRECTION-a.jpg" },
  { title: "Color Correction B", tag: "Portfolio Artwork", category: "Color Correction and Re-touchup", gradient: "var(--gradient-sage)", image: "https://rwknlleecsparayybuek.supabase.co/storage/v1/object/public/portfolio/COLOR-CORRECTION-b.jpg" },
];
...
function Works({
  ...
  const cats: Category[] = ["All", "Color Correction and Re-touchup", "Environment Concept Art", "Story Book Designs", "Story Board", "3D Asset Designs", "Storyboard Animatics", "Character Designing", "Sketching", "Digital Painting", "Posters", "Frame By Frame Animation"];
  return (
